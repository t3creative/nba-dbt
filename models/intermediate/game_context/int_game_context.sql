...
with source_game_data as (
    select
        ...
        season_year::varchar,
        game_subtype::varchar as season_type,
        series_text::varchar as series_text, -- Additional context about game series
...
base_game_context as (
    select
        ...
        g.season_type::varchar,
        g.series_text::varchar,
        g.home_team_id::integer,
        g.away_team_id::integer,
        g.home_team_score::integer,
        g.away_team_score::integer,
        g.game_status::integer as period,
        g.game_status_text::varchar as status,
        g.is_neutral::boolean,
...
select
    ...
    -- Game significance metrics
    case when g.season_type = 'Playoffs' then true else false end::boolean as is_playoff_game,
    (g.home_team_game_num > 70 and g.season_type = 'Regular Season')::boolean as is_late_season,

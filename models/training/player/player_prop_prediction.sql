...
player_form_traditional as (
    select 
        ...
        pft.blk_roll_5g_avg,
        pft.blk_roll_10g_avg,
        pft.blk_roll_20g_avg,
        pft.blk_roll_5g_stddev,
        pft.blk_roll_10g_stddev,
        pft.blk_roll_20g_stddev,
        pft.stl_roll_5g_avg,
        pft.stl_roll_10g_avg,
        pft.stl_roll_20g_avg,
        pft.stl_roll_5g_stddev,
        pft.stl_roll_10g_stddev,
        pft.stl_roll_20g_stddev,
...
-- Replace the existing stat_features CTE with this optimized version
stat_features as (
    select
        
),

-- Streamlined combined_features to remove redundant joins
combined_features as (
    select
        ...
        -- Custom calculations using rolling averages
        jd.line - sf.last_5_avg as line_vs_last_5_avg,
        jd.line - sf.last_10_avg as line_vs_last_10_avg,
        jd.line - sf.last_20_avg as line_vs_last_20_avg,
...
select
    ...
    round(win_pct_diff_last_10::numeric, 3) as win_pct_diff_last_10, -- Preserved as is, assumed to be integer
    round(fair_over_prob::numeric, 3) as fair_over_prob,
    round(fair_under_prob::numeric, 3) as fair_under_prob,
    round(last_5_avg::numeric, 3) as last_5_avg,
    round(last_10_avg::numeric, 3) as last_10_avg,
    round(last_20_avg::numeric, 3) as last_20_avg,
    round(avg_minutes::numeric, 3) as avg_minutes,
    ...
    round(pct_of_team_stat::numeric, 3) as pct_of_team_stat,
    round(opponent_def_rating::numeric, 3) as opponent_def_rating,
    round(opponent_eff_fg_pct::numeric, 3) as opponent_eff_fg_pct,
    round(opponent_ts_pct::numeric, 3) as opponent_ts_pct,
    round(opponent_pts_in_paint_allowed::numeric, 3) as opponent_pts_in_paint_allowed,
    ...
    round(line_vs_last_20_avg::numeric, 3) as line_vs_last_20_avg,

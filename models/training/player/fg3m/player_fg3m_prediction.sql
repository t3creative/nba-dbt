...
with player_props as (
    select
        ...
        -- Market is now filtered to 'Threes O/U', so market_cleaned is always 'FG3M'
        'FG3M' as market_cleaned,
    ...
    and pp.market = 'Threes O/U' -- Filter for FG3M market only
),
...
player_form_traditional as (
    select 
        ...
        -- Removed reb_roll_*
        -- Removed ast_roll_*
        pft.fg3m_roll_5g_avg, -- Kept for FG3M
        pft.fg3m_roll_10g_avg,
        pft.fg3m_roll_20g_avg,
        pft.fg3m_roll_5g_stddev,
        pft.fg3m_roll_10g_stddev,
        pft.fg3m_roll_20g_stddev,
    ...
    from {{ ref('feat_player__traditional_rolling') }} pft -- Assuming this model has fg3m_roll_* columns
...
player_form_usage as (
    select
        ...
        pfu.pct_of_team_fg3m_roll_5g_avg, -- Kept for FG3M
        pfu.pct_of_team_fg3m_roll_10g_avg,
        pfu.pct_of_team_fg3m_roll_20g_avg,
        pfu.pct_of_team_fg3m_roll_5g_stddev,
        pfu.pct_of_team_fg3m_roll_10g_stddev,
        pfu.pct_of_team_fg3m_roll_20g_stddev
    from {{ ref('feat_player__usage_rolling') }} pfu -- Assuming this model has pct_of_team_fg3m_* columns
...
combined_features as (
    select
        ...
        -- opp.opp_fg_pct as opponent_fg_pct, -- Removed (FG3 pct includes 2s and 3s, specific FG3% is better)
        opp.opp_fg3_pct as opponent_fg3_pct, -- Kept for FG3M
        ...
        opd.avg_fg3m_allowed_to_position, -- Kept for FG3M
        -- opd.avg_fg_pct_allowed_to_position, -- Removed
        opd.avg_fg3_pct_allowed_to_position, -- Kept for FG3M
        ...
        -- opd.l10_pts_allowed_to_position, -- Removed (and no l10_fg3m)
        ...
        opd.fg3m_vs_league_avg, -- Kept
        -- opd.fg_pct_vs_league_avg, -- Removed
        opd.fg3_pct_vs_league_avg, -- Kept
        ...
        -- Custom calculations
        jd.line - pft.fg3m_roll_5g_avg as line_vs_last_5_avg, -- Changed to fg3m
        jd.line - pft.fg3m_roll_10g_avg as line_vs_last_10_avg, -- Changed to fg3m
        jd.line - pft.fg3m_roll_20g_avg as line_vs_last_20_avg, -- Changed to fg3m

        case
            when pft.fg3m_roll_10g_avg > 0 then jd.line / pft.fg3m_roll_10g_avg -- Changed to fg3m
            else null
...
select
    ...
    -- round(pts_roll_5g_avg::numeric, 3) as pts_roll_5g_avg, -- Removed
    -- round(pts_roll_10g_avg::numeric, 3) as pts_roll_10g_avg, -- Removed
    -- round(pts_roll_20g_avg::numeric, 3) as pts_roll_20g_avg, -- Removed
    -- round(pts_roll_5g_stddev::numeric, 3) as pts_roll_5g_stddev, -- Removed
    round(fg3m_roll_5g_avg::numeric, 3) as fg3m_roll_5g_avg,
    round(fg3m_roll_10g_avg::numeric, 3) as fg3m_roll_10g_avg,
    round(fg3m_roll_20g_avg::numeric, 3) as fg3m_roll_20g_avg,
    round(fg3m_roll_5g_stddev::numeric, 3) as fg3m_roll_5g_stddev,
    round(fg3m_roll_10g_stddev::numeric, 3) as fg3m_roll_10g_stddev,
    round(fg3m_roll_20g_stddev::numeric, 3) as fg3m_roll_20g_stddev,
    ...
    -- round(pct_of_team_pts_roll_5g_avg::numeric, 3) as pct_of_team_pts_roll_5g_avg, -- Removed
    -- round(pct_of_team_pts_roll_10g_avg::numeric, 3) as pct_of_team_pts_roll_10g_avg, -- Removed
    -- round(pct_of_team_pts_roll_20g_avg::numeric, 3) as pct_of_team_pts_roll_20g_avg, -- Removed
    -- round(pct_of_team_pts_roll_5g_stddev::numeric, 3) as pct_of_team_pts_roll_5g_stddev, -- Removed
    -- round(pct_of_team_pts_roll_10g_stddev::numeric, 3) as pct_of_team_pts_roll_10g_stddev, -- Removed
    -- round(pct_of_team_pts_roll_20g_stddev::numeric, 3) as pct_of_team_pts_roll_20g_stddev, -- Removed
    ...
    round(pct_of_team_fg3m_roll_20g_avg::numeric, 3) as pct_of_team_fg3m_roll_20g_avg,
    ...
    round(pct_of_team_fg3m_roll_20g_stddev::numeric, 3) as pct_of_team_fg3m_roll_20g_stddev,
    ...
    round(opponent_fg3_pct::numeric, 3) as opponent_fg3_pct, -- Kept
    ...
    round(avg_fg3m_allowed_to_position::numeric, 3) as opp_avg_fg3m_allowed_to_position,
    -- round(avg_fg_pct_allowed_to_position::numeric, 3) as opp_avg_fg_pct_allowed_to_position, -- Removed
    round(avg_fg3_pct_allowed_to_position::numeric, 3) as opp_avg_fg3_pct_allowed_to_position,
    ...
    -- round(l10_pts_allowed_to_position::numeric, 3) as opp_l10_pts_allowed_to_position, -- Removed
    ...
    round(fg3m_vs_league_avg::numeric, 3) as opp_fg3m_vs_league_avg,
    -- round(fg_pct_vs_league_avg::numeric, 3) as opp_fg_pct_vs_league_avg, -- Removed
    round(fg3_pct_vs_league_avg::numeric, 3) as opp_fg3_pct_vs_league_avg,
    ...
    CASE
        ...
        ELSE 'Bad'
    END AS opp_fg3_pct_matchup_label,
    ...
    -- Custom calculations
    round(line_vs_last_5_avg::numeric, 3) as line_vs_last_5_avg, -- Uses fg3m_roll
    round(line_vs_last_10_avg::numeric, 3) as line_vs_last_10_avg, -- Uses fg3m_roll
    round(line_vs_last_20_avg::numeric, 3) as line_vs_last_20_avg, -- Uses fg3m_roll
    round(line_pct_of_avg::numeric, 3) as line_pct_of_avg, -- Uses fg3m_roll

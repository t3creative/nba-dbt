...
with player_props as (
    select
        ...
        -- Market is now filtered to 'Rebounds O/U', so market_cleaned is always 'REB'
        'REB' as market_cleaned,
...
-- Simplified to only include REB outcomes
player_outcomes as (
    select
        pbs.player_id,
        pbs.game_id,
...
player_form_traditional as (
    select 
        ...
        pft.game_id,
        pft.game_date,
        pft.reb_roll_5g_avg, -- Changed to reb
        pft.reb_roll_10g_avg, -- Changed to reb
        pft.reb_roll_20g_avg, -- Changed to reb
        pft.reb_roll_5g_stddev, -- Changed to reb
        pft.reb_roll_10g_stddev, -- Changed to reb
        pft.reb_roll_20g_stddev, -- Changed to reb
        -- Removed fg3m_roll_* stats
        -- Removed ast_roll_* stats
        -- Removed pts_roll_* stats
    ...
    from {{ ref('feat_player__traditional_rolling') }} pft -- Assuming this model has reb_roll_* columns
...
player_form_usage as (
    select
        ...
        pfu.pct_of_team_reb_roll_5g_avg, -- Kept for REB
        pfu.pct_of_team_reb_roll_10g_avg,
        pfu.pct_of_team_reb_roll_20g_avg,
        pfu.pct_of_team_reb_roll_5g_stddev,
        pfu.pct_of_team_reb_roll_10g_stddev,
        pfu.pct_of_team_reb_roll_20g_stddev
        -- Removed pct_of_team_ast_roll_*
        -- Removed pct_of_team_fg3m_roll_*
    from {{ ref('feat_player__usage_rolling') }} pfu -- Assuming this model has pct_of_team_reb_* columns
...
combined_features as (
    select
        ...
        pft.reb_roll_5g_avg,
        pft.reb_roll_10g_avg,
        pft.reb_roll_20g_avg,
        pft.reb_roll_5g_stddev,
        pft.reb_roll_10g_stddev,
        pft.reb_roll_20g_stddev,
        pft.min_roll_5g_avg,
        pft.min_roll_10g_avg,
        pft.min_roll_20g_avg,
        pft.min_roll_5g_stddev,
        ...
        pfa.usage_pct_roll_10g_stddev,
        pfa.usage_pct_roll_20g_stddev,
        pfu.pct_of_team_reb_roll_5g_avg,
        pfu.pct_of_team_reb_roll_10g_avg,
        pfu.pct_of_team_reb_roll_20g_avg,
        pfu.pct_of_team_reb_roll_5g_stddev,
        pfu.pct_of_team_reb_roll_10g_stddev,
        ...
        opp.opp_def_reb_pct as opponent_def_reb_pct, -- Kept for REB
        ...
        -- opd.avg_fg_pct_allowed_to_position, -- Removed
        -- opd.avg_fg3_pct_allowed_to_position, -- Removed
        -- opd.avg_pts_ast_allowed_to_position, -- Removed
        -- opd.avg_pts_reb_allowed_to_position, -- Removed (combo stat)
        -- opd.avg_pts_reb_ast_allowed_to_position, -- Removed
        -- opd.avg_ast_reb_allowed_to_position, -- Removed (combo stat)
        -- opd.l10_reb_allowed_to_position, -- Removed as likely does not exist

        -- Numerical matchup quality indicators (_vs_league_avg)
        -- opd.pts_vs_league_avg, -- Removed
        opd.reb_vs_league_avg, -- Kept
        -- opd.ast_vs_league_avg, -- Removed
        -- opd.stl_vs_league_avg, -- Removed
        -- opd.blk_vs_league_avg, -- Removed
        -- opd.fg3m_vs_league_avg, -- Removed
        -- opd.fg_pct_vs_league_avg, -- Removed
        ...
        -- Custom calculations
        jd.line - pft.reb_roll_5g_avg as line_vs_last_5_avg, -- Uses reb_roll
        jd.line - pft.reb_roll_10g_avg as line_vs_last_10_avg, -- Uses reb_roll
        jd.line - pft.reb_roll_20g_avg as line_vs_last_20g_avg, -- Uses reb_roll

        case
            when pft.reb_roll_10g_avg > 0 then jd.line / pft.reb_roll_10g_avg -- Uses reb_roll
            else null
...
select
    ...
    round(reb_roll_5g_avg::numeric, 3) as reb_roll_5g_avg,
    round(reb_roll_10g_avg::numeric, 3) as reb_roll_10g_avg,
    round(reb_roll_20g_avg::numeric, 3) as reb_roll_20g_avg,
    round(reb_roll_5g_stddev::numeric, 3) as reb_roll_5g_stddev,
    round(reb_roll_10g_stddev::numeric, 3) as reb_roll_10g_stddev,
    round(reb_roll_20g_stddev::numeric, 3) as reb_roll_20g_stddev,
    -- Removed other traditional rolling stats
    ...
    -- Removed pct_of_team_pts_roll_*
    round(pct_of_team_reb_roll_5g_avg::numeric, 3) as pct_of_team_reb_roll_5g_avg,
    round(pct_of_team_reb_roll_10g_avg::numeric, 3) as pct_of_team_reb_roll_10g_avg,
    round(pct_of_team_reb_roll_20g_avg::numeric, 3) as pct_of_team_reb_roll_20g_avg,
    round(pct_of_team_reb_roll_5g_stddev::numeric, 3) as pct_of_team_reb_roll_5g_stddev,
    round(pct_of_team_reb_roll_10g_stddev::numeric, 3) as pct_of_team_reb_roll_10g_stddev,
    round(pct_of_team_reb_roll_20g_stddev::numeric, 3) as pct_of_team_reb_roll_20g_stddev,
    -- Removed pct_of_team_ast_roll_*
    -- Removed pct_of_team_fg3m_roll_*
    ...
    round(opponent_def_reb_pct::numeric, 3) as opponent_def_reb_pct, -- Kept
    -- round(opponent_fg_pct::numeric, 3) as opponent_fg_pct, -- Removed
    ...
    round(avg_reb_allowed_to_position::numeric, 3) as opp_avg_reb_allowed_to_position,
    -- round(avg_ast_allowed_to_position::numeric, 3) as opp_avg_ast_allowed_to_position, -- Removed
    ...
    -- round(avg_fg_pct_allowed_to_position::numeric, 3) as opp_avg_fg_pct_allowed_to_position, -- Removed
    ...
    -- round(l10_reb_allowed_to_position::numeric, 3) as opp_l10_reb_allowed_to_position, -- Removed as likely does not exist

    -- Numerical matchup quality indicators (_vs_league_avg)
    -- round(pts_vs_league_avg::numeric, 3) as opp_pts_vs_league_avg, -- Removed
    round(reb_vs_league_avg::numeric, 3) as opp_reb_vs_league_avg,
    -- round(ast_vs_league_avg::numeric, 3) as opp_ast_vs_league_avg, -- Removed
    ...
    -- round(fg_pct_vs_league_avg::numeric, 3) as opp_fg_pct_vs_league_avg, -- Removed
    ...
    CASE
        WHEN COALESCE(reb_vs_league_avg, 0.0) > 2.0 THEN 'Great'
        WHEN COALESCE(reb_vs_league_avg, 0.0) > 0.75 THEN 'Good'
        WHEN COALESCE(reb_vs_league_avg, 0.0) >= -0.75 THEN 'Average'
        WHEN COALESCE(reb_vs_league_avg, 0.0) >= -2.0 THEN 'Poor'
        ELSE 'Bad'
    END AS opp_reb_matchup_label,
    -- CASE ... opp_ast_matchup_label, -- Removed
    -- CASE ... opp_stl_matchup_label, -- Removed
    -- CASE ... opp_blk_matchup_label, -- Removed
    -- CASE ... opp_fg3m_matchup_label, -- Removed
    -- CASE ... opp_fg_pct_matchup_label, -- Removed
    ...
    -- Custom calculations
    round(line_vs_last_5_avg::numeric, 3) as line_vs_last_5_avg, -- Uses reb_roll
    round(line_vs_last_10_avg::numeric, 3) as line_vs_last_10_avg, -- Uses reb_roll
    round(line_vs_last_20g_avg::numeric, 3) as line_vs_last_20_avg, -- Uses reb_roll
    round(line_pct_of_avg::numeric, 3) as line_pct_of_avg, -- Uses reb_roll
